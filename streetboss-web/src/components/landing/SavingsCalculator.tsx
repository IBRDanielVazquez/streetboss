    ...
    <section id="calculadora" className="py-24 bg-gradient-to-b from-[#050505] to-[#0a0a0a] relative border-b border-white/5">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 font-poppins">Calcula tu ahorro mensual</h2>
        ...
        <div className="bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <label className="block text-lg font-bold mb-6 text-center font-poppins">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 text-center">
                ...
                <p className="text-3xl font-bold text-red-400 font-poppins">-${(ventasMensuales * comisionPromedio).toLocaleString()} MXN</p>
              ...
              <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-6 text-center shadow-[0_0_30px_rgba(34,197,94,0.1)] transform md:-translate-y-2">
                ...
                <p className="text-4xl font-extrabold text-green-400 font-poppins">+${(ventasMensuales * comisionPromedio).toLocaleString()} MXN</p>

    ...
    <section className="py-24 bg-[#050505] border-t border-white/5">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 font-poppins">Preguntas Frecuentes</h2>
        ...
        <div className="space-y-6">
          {FAQS.map((faq, i) => (
            <div key={i} className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-6">
              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-3 font-poppins">

      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="max-w-2xl mx-auto text-left">
          <div className="bg-gradient-to-b from-[#111] to-black border border-primary/30 rounded-[2.5rem] p-8 md:p-12 relative shadow-[0_0_50px_rgba(245,184,122,0.15)] flex flex-col text-center">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#f5b87a] text-black text-xs font-black px-5 py-1.5 rounded-full uppercase tracking-widest shadow-[0_0_20px_rgba(245,184,122,0.5)] whitespace-nowrap">
              OFERTA DE LANZAMIENTO 🚀
            </div>
            <h3 className="text-2xl md:text-3xl font-black text-white mb-2 mt-2">Oferta de lanzamiento</h3>
            ...
            <div className="mb-8 pb-8 border-b border-white/10 flex flex-col items-center">
              ...
              <div className="flex items-baseline justify-center">
                <span className="text-5xl font-extrabold text-[#ff4b16]">$99</span>
              ...
              <p className="text-xs text-gray-500 mt-2 max-w-sm leading-relaxed">
                Después $249 MXN / mes. Sin comisiones por venta.
              </p>
            </div>
            ...
            <a 
              href="https://wa.me/529612466204?text=Hola,%20quiero%20mi%20menu%20digital" 
              target="_blank" 
              rel="noreferrer" 
